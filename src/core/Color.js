export default class Color {
  ...
  static screenC(t, b) {
    return Math.floor(255 - (255 - t) * (255 - b));
  }
  screen(color) {
  ...
  static vividC(t, b) {
    return b > 127 ? this.burnC(t, b) : this.dodgeC(t, b);
  }
  vivid(color) {
  ...
  static multiplyC(t, b) {
    return Math.round((t * b) / 255);
  }
  multiply(color) {
  ...
  static multiplyCAlpha(t, b, a) {
    return Math.round((t * (b * a)) / 255);
  }
  ...
  shift(perc) {
    this.r = Math.min(this.r * perc, 255);
    this.g = Math.min(this.g * perc, 255);
    this.b = Math.min(this.b * perc, 255);
    return this;
  }
